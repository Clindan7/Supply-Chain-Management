...
@Component({
  selector: 'app-chat-supplier',
  templateUrl: './chat-supplier.component.html',
  styleUrls: ['./chat-supplier.component.css']
})
export class ChatSupplierComponent implements OnInit {
  data1: any;
  id: any;
  user: any;
  senderId: any;
...
this.ema=localStorage.getItem('email');
    ...
    this.cht.LoadPurchaser().subscribe(data=>{
      this.users=data
      console.log("%%%%%%%555",this.users);
